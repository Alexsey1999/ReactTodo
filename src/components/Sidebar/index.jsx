...
const Sidebar = ({
  ...
  const togglePanel = () => {
    setIsActivePanel((prevVal) => !prevVal)
  }
  ...
  return (
    <div className="sidebar-content">
      <Button
        className={classNames('all-tasks-btn', { active: activeTask === null })}
        active
      ...
      <List
        ...
        setTasks={setTasks}
      />
      <Button className="add-category-btn" onClick={togglePanel}>
        <svg
          width="16"
          height="16"
          viewBox="0 0 16 16"
